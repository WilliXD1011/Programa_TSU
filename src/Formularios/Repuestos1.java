 ...
 * @author WILLROSS
 */
public class Repuestos1 extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Repuestos1.class.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Repuestos1().setVisible(true));
    }
